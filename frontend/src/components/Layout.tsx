...
import { BusinessSidebarProgress } from './BusinessProgressWidgets';
...
const navItems = {
  business: [
    ...
    { to: '/business/progress', label: 'Прогресс бизнеса', icon: Trophy },
